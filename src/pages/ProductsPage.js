...
function ProductList() {
  ...
  useEffect(() => {
    axios.get('https://nika-scandi-assignment.000webhostapp.com/api/products')
  ...
  data: skusToDelete
    ...
    .then(response => {
      if (response.status == 204) {
        ...
        setProducts(prevProducts => prevProducts.filter(product => !skusToDelete.includes(product.id)));
